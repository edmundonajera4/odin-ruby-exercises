...
describe "temperature conversion function" do
	...
	describe "#ctof" do
		...
		it "convertz freezing temperature" do
			expect(ctof(0)).to eq(32)
		end

		it "convertz boiling temperature" do
			expect(ctof(100)).to eq(212)
		end 

		it "convertz arbitrary temperatur" do
			expect(ctof(20)).to eq(68)
		end

		it "convertz body temperature" do
